import { deepEquals, lazyDeepEquals, leftArrayIncludesRightArray, leftArrayIncludesRightArraySorted } from "../Comparator";
...
describe("Comparator", () => {
  ...
  describe("#lazyDeepEquals", () => {
    ...
    it.each(tests)("should decide equally in object lazy deep equally. %o", (test) => {
  ...
  describe("#leftArrayIncludesRightArray", () => {
    ...
    it.each(tests)("should decide right items are included left array. %o", (...right) => {
  ...
  describe("#leftArrayIncludesRightArraySorted", () => {
    ...
    it.each(tests)("should decide right items are included left array maintain order and continuity.", (...right) => {
      expect(leftArrayIncludesRightArraySorted(left, right)).toBe(true);
    });
    it.each(failures)("should return false right are not right order.", (...right) => {
